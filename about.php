...
<body>
   ...
   <!-- content sections start -->
                ...
                <div class="inner-box">
                    ...
                    <ul class="contact-list-one">
                        ...
                        <li>
                            ...
                            <div class="text"><a href="#"><span class="#" data-cfemail="#"><span class="__cf_email__" data-cfemail="b6c5dec4dfc4d7dbd7d8c5dedfd8d0c4d7d5d9c4c6f6d1dbd7dfda98d5d9db">[email&#160;protected]</span></span></a></div>
                        </li>
                        <li>
                            <i class="icon lnr-icon-map-marker"></i>
                            <span class="title">Address</span>
                            <div class="text ">
                                <p class="text-light">12A/72, Vrindavan Yojna, Lucknow - 226029</p>
                            </div>
                        </li>
                    </ul>
    ...
    <section class="page-title" style="background-image: url(siteadmin/images/background/aboutbg.png);">
    		<div class="auto-container">
    			<div class="title-outer d-sm-flex align-items-center justify-content-sm-between">
    				<h1 class="title text-light">About Us</h1>
