...
.list-style-two.two-column li .linktab {
    color: #000;
}
...
.gd-text {
    color: #ffffff;
    background-image: -webkit-linear-gradient(54.39deg, #f36234 28.27%, #fa8535 47.32%, #d19e55 51.53%, #fbb252 61.73%, #e6973f 70.81%);
...
.testimonial-section-six .owl-carousel .owl-nav .owl-next {
    ...
    border-radius: 0;
    border: unset;
    background-color: rgb(var(--theme-color1-rgb), 0.5);
    color: var(--theme-color-light);
}
...
.footer-style-seven .footer-upper .outer-box .upper-right .info-btn .icon {
    ...
    line-height: 55px;
    border-radius: 50%;
    background-color: rgb(var(--theme-color1-rgb), 0.1);
    font-size: 16px;
    color: var(--theme-color1);
    text-align: center;
    -webkit-transition: all 300ms ease;
